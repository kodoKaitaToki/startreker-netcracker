...
public interface StatisticsService {
    ...
    List<CarrierViewsResponse> getTripsViewsStatisticsByTripByWeek(User caller, long tripId, LocalDate from, LocalDate to);
    List<CarrierViewsResponse> getTripsViewsStatisticsByTripByMonth(User caller, long tripId, LocalDate from, LocalDate to);
    ...
    List<CarrierViewsResponse> getServiceViewsStatisticsByServiceByWeek(User caller, long serviceId, LocalDate from, LocalDate to);
    List<CarrierViewsResponse> getServiceViewsStatisticsByServiceByMonth(User caller, long serviceId, LocalDate from, LocalDate to);
}
