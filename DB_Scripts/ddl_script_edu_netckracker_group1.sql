...
DROP TABLE IF EXISTS CLASS_SUGGESTION;
DROP TABLE IF EXISTS SERVICE_SUGGESTION;

CREATE TABLE CLASS_SUGGESTION(
  OWNERCLASS_ID INTEGER NOT NULL,
  SLAVECLASS_ID INTEGER NOT NULL,
