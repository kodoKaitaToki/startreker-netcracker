...
CREATE TABLE POSSIBLE_SERVICE(
	...
	TRIP_ID INTEGER REFERENCES TICKET_CLASS (CLASS_ID),
...
insert into ROLE_A (ROLE_NAME) values ('role_administrator');
...
insert into DISCOUNT_SERVICE (DISCOUNT_ID, SERVICE_ID) values (2, 1);
insert into DISCOUNT_SERVICE (DISCOUNT_ID, SERVICE_ID) values (2, 2);
insert into DISCOUNT_SERVICE (DISCOUNT_ID, SERVICE_ID) values (2, 3);
insert into DISCOUNT_SERVICE (DISCOUNT_ID, SERVICE_ID) values (3, 14);
insert into DISCOUNT_SERVICE (DISCOUNT_ID, SERVICE_ID) values (3, 22);

insert into SCHEDULE (START_DATE, FINISH_DATE, INTERVAL, CREATION_DATE) values ('2016-08-03', '2020-08-03', 365, '2016-08-02');

insert into REPORT (REPORTER_ID, APPROVER_ID, TRIP_ID, STATUS, REPORT_RATE, REPORT_TEXT, CREATION_DATE) values (15, null, 7, null, 6, 'donec posuere metus vitae ipsum aliquam non mauris morbi non lectus aliquam sit', '2018-12-09');
